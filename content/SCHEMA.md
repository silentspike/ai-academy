...
> Rechtsstand aller Inhalte: **Arbeitskonsolidierung 27.7.2026** (Gate 0, `legal/`).
...
- `reviewed` erfordert BEIDE Eigenprüfungs-Durchgänge (getrennt, protokolliert in
  `legal/eigenpruefung-content.md`): (i) Skript-Abgleich prüfbarer Angaben, (ii) Volltext-Zweitdurchsicht.
